...
public class FunctionRequest : Request, ICloneable
{
    ...
    public float Time => TimeParam != null && float.TryParse(TimeParam.StringData, out var help) ? help : _time;

    public int RepeatCount =>
        RepeatCountParam != null && int.TryParse(RepeatCountParam.StringData, out var help) ? help : 1;
    ...
    public override Request SetupFromLines(List<Parameter> Lines)
    {
        ...
        var name = DefiningParameter.Clean.Name;
