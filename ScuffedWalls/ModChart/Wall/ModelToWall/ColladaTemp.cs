...
/// <summary>
///     A basic schema structure of a collada file. Made specifically for blender, idk how other modeling programs will
///     export.
/// </summary>
[Serializable]
[XmlRoot(Namespace = "http://www.collada.org/2005/11/COLLADASchema", ElementName = "COLLADA")]
public class Collada
{
    ...
    public class Library_Animations
    {
        ...
        public class Animations
        {
            ...
            public class Animation
            {
                ...
                [XmlElement(ElementName = "source")] public Source[] sources { get; set; }
                ...
                public class Source
                {
                    ...
                    {
                        [XmlText] public string values { get; set; }
    ...
    {
        [XmlElement(ElementName = "effect")] public Effect[] effect { get; set; }
        ...
        public class Effect
        {
            ...
            public class Profile_Common
            {
                ...
                {
                    [XmlElement(ElementName = "lambert")] public Lambert lambert { get; set; }

                    public class Lambert
                    {
                        [XmlElement(ElementName = "diffuse")] public Diffuse diffuse { get; set; }
    ...
    public class Visual_scenes
    {
        ...
        {
            [XmlElement(ElementName = "node")] public Node[] node { get; set; }
            ...
            public class Node
            {
                ...
                [XmlElement(ElementName = "matrix")] public string matrix { get; set; }

                [XmlElement(ElementName = "instance_geometry")]
                public Instance_Geometry instance_geometry { get; set; }

                [XmlElement("instance_camera")] public Instance_cam instance_cam { get; set; }
